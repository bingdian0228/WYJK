...
namespace WYJK.Data.ServiceImpl
{
    ...
    public class BaseAuditService : IBaseAuditService
    {
        ...
        public PagedResult<BaseAuditList> GetBaseAuditList(BaseAuditParameter parameter)
        {
            ...
            string innersqlstr = $@" select ssp.SocialSecurityPeopleName SocialSecurityPeopleName,m.UserType UserType,m.MemberName MemberName,m.MemberID,m.EnterpriseName,m.BusinessName,  t.* 
 from BaseAudit t
