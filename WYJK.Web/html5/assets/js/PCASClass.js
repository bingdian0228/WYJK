...
function PCAS() {
	...
	this.SelC = document.getElementById(arguments[2]);
	this.SelA = document.getElementById(arguments[3]);
	this.DefP = this.SelA ? arguments[4] : arguments[3];
	this.DefC = this.SelA ? arguments[5] : arguments[4];
	this.DefA = this.SelA ? arguments[6] : arguments[5];
	this.SelP.PCA = this;
	this.SelC.PCA = this;
	//附加-回调函数,设置市区的时候，调用此函数；
	this.callback = arguments[0];
	this.SelP.onchange = function() {
		PCAS.SetC(this.PCA);
		//附加回调函数
		if (typeof this.PCA.callback == "function") {
			this.PCA.callback();
		}
	};
